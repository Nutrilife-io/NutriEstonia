...
contract StandardToken is ERC20, BasicToken {
    ...
    /**
     * @dev Function Increase approval of the amount of tokens that an owner allowed
     * @param _spender address The address which owns the funds.
     * @param _addedValue add value from allowed balance.
     * @return A boolean specifying the status of increase approval token
     */
    ...
    /**
     * @dev Function Decrease approval of the amount of tokens that an owner allowed
     * @param _spender address The address which owns the funds.
     * @param _subtractedValue substract value from allowed balance.
     * @return A boolean specifying the status of decrease approval token
     */
...
contract NLCToken is StandardToken {
    ...
    /// The owner of this address will distrbute the tokens
    ...
    * @param investor invester-user doing investment
    * @param value weis paid for investment
    */
    event Investment(address indexed investor, uint256 value);
    
    /**
    * Event for submitting token purchase request
    * @param investor invester-user requesting investment
    * @param value weis request to invest
    */
    event TokenPurchaseRequestFromInvestment(address indexed investor, uint256 token);
    
    /**
    * Event for approving token purchase request
    * @param investor approver requesting for investment
    * @param token weis request to invest
    */    
